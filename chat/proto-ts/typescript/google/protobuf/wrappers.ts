...
export namespace google.protobuf {
  export class DoubleValue extends pb_1.Message {
    ...
    static fromObject(data: { value?: number }): DoubleValue {
  ...
  export class FloatValue extends pb_1.Message {
    ...
    static fromObject(data: { value?: number }): FloatValue {
  ...
  export class Int64Value extends pb_1.Message {
    ...
    static fromObject(data: { value?: number }): Int64Value {
  ...
  export class UInt64Value extends pb_1.Message {
    ...
    static fromObject(data: { value?: number }): UInt64Value {
  ...
  export class Int32Value extends pb_1.Message {
    ...
    static fromObject(data: { value?: number }): Int32Value {
  ...
  export class UInt32Value extends pb_1.Message {
    ...
    static fromObject(data: { value?: number }): UInt32Value {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.value != 0) writer.writeUint32(1, this.value);
      if (!w) return writer.getResultBuffer();
    }
  ...
  export class BoolValue extends pb_1.Message {
    ...
    static fromObject(data: { value?: boolean }): BoolValue {
  ...
  export class StringValue extends pb_1.Message {
    ...
    static fromObject(data: { value?: string }): StringValue {
  ...
  export class BytesValue extends pb_1.Message {
    ...
    static fromObject(data: { value?: Uint8Array }): BytesValue {
